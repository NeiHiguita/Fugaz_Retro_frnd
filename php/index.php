...
<head>
    <meta charset="UTF-8">
    <link rel="stylesheet" href="/Fugaz_Retro/css/style.css">
...
<body>
    ...
    <section class="headerandmenu">
        <header class="barraSup">
            ...
            <p class="icons">
                <a href="https://www.facebook.com/profile.php?id=100039835783405" target="_blank"><img src="/Fugaz_Retro/icons/facebook-circle-logo-84.png" height="24" alt=""></a>
                <a href="https://www.instagram.com/fug.az202/" target="_blank"><img src="/Fugaz_Retro/icons/instagram-logo-84.png" alt="" height="24"></a>
                <a href="#"><img src="/Fugaz_Retro/icons/whatsapp-logo-84.png" height="24" alt=""></a>
            </p>
        </header>
        <!-- barra de buzqueda -->
        <div class="menu">
            ...
            <div>
                <div class="busqueda">
                    ...
                    <div class="icono-lupa">
                        <img src="/Fugaz_Retro/icons/search-regular-24.png" alt="">
                    </div>
                </div>
                <div class="iconos" style="margin-top: -31px;">
                    <div class="icono">
                        <a href="/Fugaz_Retro/backend/index.php"><img src="/Fugaz_Retro/icons/dashboard-solid-24.png" height="24" alt=""></a>
                    </div>
                    <div class="icono">
                        <a href="/Fugaz_Retro/php/login.php"><img src="/Fugaz_Retro/icons/user-circle-regular-84.png" height="24" alt=""></a>
                    </div>
                    <div class="icono">
                        <a href="#"><img src="/Fugaz_Retro/icons/cart-regular-84.png" height="24" alt=""></a>
                    </div>
                    <div class="icono">
                        <a href="#"><img src="/Fugaz_Retro/icons/heart-regular-84.png" height="24" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="burguer-menu">
            <img src="/Fugaz_Retro/icons/menu-regular-84.png" alt="">
        </div>
    ...
    <section class="slider">
        <div class="swiper">
            <div class="swiper-wrapper">
                <!-- Slides -->
                <div class="swiper-slide"><img src="/Fugaz_Retro/img/Almas Fugaces.png" alt="Almas Fugaces" style="width: 100%;">
                </div>
                <div class="swiper-slide"><img src="/Fugaz_Retro /img/img1.png" alt="" style="width: 100%;"></div>
                <div class="swiper-slide"><img src="/Fugaz_Retro /img/Imagen.png" alt="" style="width: 100%;"></div>
                <div class="swiper-slide"><img src="/Fugaz_Retro /img/mas info.png" alt="" style="width: 100%;"></div>
                ....
    ...
    <section class="cjventas">
        ...
        <div class="cjventa" id="cjventa">
            <div class="cj">
                ...
                <img src="/Fugaz_Retro /img/prenda0001.jpg" alt="">
                <p>Vestido melito</p>
                <form class="btnven" action="" method="post">
                    <div class="ch"><input id="ch" type="submit" value="Comprar">&nbsp;<img
                            src="/Fugaz_Retro /icons/shopping-bag-regular-24.png" alt="" style="width: 20px;
                            height: 20px;"></div>
                    <div class="ac"><input id="ac" type="submit" value="Añadir">&nbsp;<img
                            src="/Fugaz_Retro /icons/cart-add-regular-24.png" alt="" style="width: 20px;
                            height: 20px;"></div>
                </form>
            </div>
            <div class="cj">
                <a href="#"><box-icon name='heart' animation='tada' flip='horizontal'></box-icon></a>
                <img src="/Fugaz_Retro /img/prenda0002.jpg" alt="">
            ...
            <div class="cj">
                <a href="#"><box-icon name='heart' animation='tada' flip='horizontal'></box-icon></a>
                <img src="/Fugaz_Retro /img/prenda0003.jpg" alt="">
                <p>NOMBRE DE LA PRENDA</p>
                <form class="btnven" action="" method="post">
                    <div class="ch"><input id="ch" type="submit" value="Comprar">&nbsp;<img
                            src="/Fugaz_Retro /icons/shopping-bag-regular-24.png" alt="" style="width: 20px;
    ...
    <section class="cjventas">
        ...
        <div class="fugazlovers">
            ...
            <div class="container col-8" style="display: flex; background-color:#e2b091 ; padding: 20px 0px 0px 100px; border-radius: 10px; margin-bottom: 70px;">
                <div class="col-3">
                    <img src="/Fugaz_Retro /img/prenda0001.jpg" alt="" style="height: 300px; width: 300px; margin-bottom: 200px ma; " class="">
                </div>
